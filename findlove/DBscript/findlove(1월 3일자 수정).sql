...
-- 18. 일대일 문의 테이블
INSERT INTO TB_INQ
VALUES (TB_INQ_SEQ.NEXTVAL, '매칭 문의드립니다.', '매칭 애니메이션 너무 잘만드셨어요!', DEFAULT, NULL, NULL, 'user11', 'admin');
INSERT INTO TB_INQ
VALUES (TB_INQ_SEQ.NEXTVAL, '출석체크 문의합니다.', '하루에 포인트 얼마나 주나요?', DEFAULT, NULL, NULL, 'user22', 'admin');
INSERT INTO TB_INQ
VALUES (TB_INQ_SEQ.NEXTVAL, '매칭 질문', '매칭 완료시 메시지 보내는건 무료인가요?', DEFAULT, NULL, NULL, 'user33', 'admin');
INSERT INTO TB_INQ
VALUES (TB_INQ_SEQ.NEXTVAL, 'RE: 매칭 문의드립니다.', '안녕하세요 고객님 findlove 입니다. 앞으로 더 발전하는 모습을 보여드리도록 노력하겠습니다. 항상 findlove를 이용해주셔서 감사합니다.', DEFAULT, NULL, NULL, 'admin', 'user11');
INSERT INTO TB_INQ
VALUES (TB_INQ_SEQ.NEXTVAL, 'RE: 출석체크 문의합니다.', '안녕하세요 고객님 findlove 입니다. 하루 출석체크시 지급해드리는 포인트는 100p로 한달 연속 출첵시 추가로 1000p를 더 지급해드리고 있습니다. 항상 findlove를 이용해주셔서 감사합니다.', DEFAULT, NULL, NULL, 'admin', 'user22');
INSERT INTO TB_INQ
VALUES (TB_INQ_SEQ.NEXTVAL, 'RE: QnA 매칭 질문', '안녕하세요 고객님 findlove 입니다. QnA 매칭 성공시 메세지 보내는 무료로 제공해 드리고있습니다. 항상 findlove를 이용해주셔서 감사합니다.', DEFAULT, NULL, NULL, 'admin', 'user33');
-- 19. 자유게시판 댓글 테이블

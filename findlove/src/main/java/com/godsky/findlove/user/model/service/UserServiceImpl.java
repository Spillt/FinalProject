...
public class UserServiceImpl implements UserService{
	...
	public boolean loginCheck(User vo, HttpSession session){
		...
		if(result){
			...
			session.setAttribute("phone", vo2.getPhone());
	...
	public String loginUserCheck(String userId) {
		return userDao.loginUserCheck(userId);
	}
	...
	public int checkNicknm(User user) {
		return userDao.checkNicknm(user);
	}
	//로그인 2
	/*@Override
	...
	public int getPointCnt(String userId) {
		return userDao.getPointCnt(userId);
	}


	@Override
	public int getKonpeitoCnt(String userId) {
		return userDao.getKonpeitoCnt(userId);
	}


	@Override
	public List<Image> getImageList(String user_id) {
		return userDao.getImageList(user_id);
	}

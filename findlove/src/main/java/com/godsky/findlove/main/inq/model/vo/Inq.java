...
public class Inq {
	...
	public String getInqReplyFL() {
		return inqReplyFL;
	}

	public void setInqReplyFL(String inqReplyFL) {
		this.inqReplyFL = inqReplyFL;
	}
	...
	public String toString() {
		return "Inq [inqNo=" + inqNo + ", inqTitle=" + inqTitle + ", inqContent=" + inqContent + ", inqDate=" + inqDate
				+ ", inqOFN=" + inqOFN + ", inqRFN=" + inqRFN + ", inqWriter=" + inqWriter + ", inqReciver="
				+ inqReciver + ", inqReplyFL=" + inqReplyFL + "]";
	}

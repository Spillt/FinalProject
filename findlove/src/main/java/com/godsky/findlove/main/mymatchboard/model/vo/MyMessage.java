...
public class MyMessage {
	...
	public MyMessage(int message_no, String user_nicknm, String picture_nm, String age, String area, String sender_id,
			String receiver_id, String message_content, Date send_DT, String read_FL, String accept_ST) {
		super();
	...
	public String toString() {
		return "Message [message_no=" + message_no + ", user_nicknm=" + user_nicknm 
				+ ", picture_nm "+ picture_nm + ", age" + age + ", area" + area

...
public class MatchQnAServiceImpl implements MatchQnAService{
	...
	public String selectUserNickNM(String userId) {
		return matchQnADao.selectUserNickNM(userId);
	}

	@Override
	public void subtractPoint(String userId) {
		matchQnADao.subtractPoint(userId);
		
	}

	@Override
	public void rematchTry(String userId) {
		matchQnADao.rematchTry(userId);
	...
	public int sendMessage(Message message) {
		...
		return matchQnADao.sendMessage(message);
	}

	@Override
	public int checkExistAnswer(String userId) {
		return matchQnADao.checkExistAnswer(userId);

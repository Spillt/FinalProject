		...
		<div class="row">
			...
			<div class="col-lg-3">
				...
				<div class="list-group">
					<a href="#" class="list-group-item">이상형 월드컵</a>
					<a href="selectuserlist.do?userId=${user_id }"
						class="list-group-item">QNA 매칭</a>
					<c:if test="${!empty myQnA}">
						<a href="myMatchqna.do?userId=${user_id }" class="list-group-item active">내
							QnA 수정</a>
					</c:if>
					<c:if test="${empty myQnA}">
						<a href="listMatchqna.do" class="list-group-item">내 QnA 설정</a>
					</c:if>

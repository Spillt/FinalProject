		...
		<div class="row">
			<div class="col-lg-3">
				...
				<div class="list-group">
					...
					<a href="#" class="list-group-item active">나에게 높은 평점을 준 이성</a>
				</div>
			</div>

			<div class="col-lg-9">
				<div class="card card-outline-secondary my-4">
					<div class="card-header">나에게 높은 평점을 준 이성</div>
					 ...
					 <c:otherwise>
					  ...
					  <br><br><br>
					  <br><br><br>
					  <h2 align="center" style="color:#faadad;">나에게 높은 평점을 준 이성이 없습니다.</h2>
					  <br><br><br>
					  <br><br><br>
					  <br><br><br>
					</c:otherwise>

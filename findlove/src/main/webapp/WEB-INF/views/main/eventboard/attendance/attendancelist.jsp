...
attimg.offset().top;
attimg.offset().left;
attimg.offset({top: 500, left: 200});
} */
</style>
</head>
<body>
...
<img id="attimg" src="#" style="position: absolute;z-index:1; margin-left: 943px; margin-top: 200px; width: 124px;">
   ...
   <div class="event">
      <ul>
         ...
         <div style="position: absolute; margin-left: 630px; margin-top: 25px">
            <%-- <li class="nav-item"><a
               class="btn btn-primary nav-link js-scroll-trigger"
               href="attendancebtn.do?userId=${user_id}">Today Check</a></li> --%>
               <li class="nav-item"><a
               class="btn btn-primary nav-link js-scroll-trigger" id="test"
               href="#">Today Check</a></li>
         </div>
   ...
   <script type="text/javascript">
      ...
      $(document).ready(function() {
         ...
         $('#test').on('click', function() {
            ...
            $('#attimg').attr("src","/findlove/resources/img/att.png")
         });

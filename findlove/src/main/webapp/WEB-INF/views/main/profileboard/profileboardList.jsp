						...
						<div class="col-lg-3 col-md-4 col-sm-6 portfolio-item">
							<div class="card h-60">
								<a
									...
									class="card-img-top"
									src="/findlove/uploadfiles/profile/${ profile.picture_NM }"
									alt=""></a>
								...
								<div class="card-body">
									<h4 class="card-title">
										<span style="color: #faadad; font-size: 25px;">${ profile.user_NickNM }
											...
											src="/findlove/resources/img/starGrade/starGrade${ profile.grade_AVG }.png"
											width=120, height=30></span> <br>
										<br> <span style="color: black; font-size: 18px;">
											${ profile.age }세, ${ profile.area } </span>
									</h4>
								</div>
							</div>
						</div>

...
<body id="page-top">
					...
					<c:if test="${sessionScope.user_id ne 'admin' }"> 
						...
						<div class="col-lg-3">
							<button type="button" class="btn btn-default btn-block"
								...
								data-msg="${ p.user_NickNM }">호감 메세지 보내기</button>

							<button type="button" class="btn btn-default btn-block"
								data-toggle="modal" data-target="#exampleModal3"
								data-grade="${ p.user_NickNM }">별점 매기기</button>

							<button type="button" class="btn btn-danger btn-block"
								data-toggle="modal" data-target="#exampleModal2"
								data-report="${ p.user_NickNM }">신고하기</button>
						</div>
         ...
         <div class="modal-content">
            ...
            <div class="modal-body">
               <form>
                  <div class="form-group">
                     <label for="recipient-name" class="control-label">받는사람:</label> <input
                        type="text" class="form-control" id="recipient-name" name="recipient" readonly>
                  </div>
                  <div class="form-group">
                     <div class="radio">
					  <label>
					    <input type="radio" name="optionsRadios" id="optionsRadios1" value="광고(스팸)" checked>
					    광고(스팸)
					  </label>
					</div>
					<div class="radio">
					  <label>
					    <input type="radio" name="optionsRadios" id="optionsRadios2" value="욕설/비난">
					 욕설/비난
					  </label>
					</div>
					<div class="radio">
					  <label>
					    <input type="radio" name="optionsRadios" id="optionsRadios2" value="부적절한 게시글">
					 부적절한 게시글
					  </label>
					</div>
					<div class="radio">
					  <label>
					    <input type="radio" name="optionsRadios" id="optionsRadios2" value="도배">
					 도배
					  </label>
					</div>
                   ...
                   <div class="form-group">
                     <label for="content" class="control-label">상세사유:</label>
            ...
            <div class="modal-body">
               <form>
                  ...
                  <div class="form-group">
                     ...
                     <label for="grade" class="control-label">별점을 선택해주세요 (0부터 5까지 설정 가능)</label>
   ...
   <script type="text/javascript">
      $('#exampleModal2').on('show.bs.modal', function(event) {
         var button = $(event.relatedTarget) // Button that triggered the modal
         var recipient = button.data('report')// Extract info from data-* attributes
         // If necessary, you could initiate an AJAX request here (and then do the updating in a callback).
         // Update the modal's content. We'll use jQuery here, but you could use a data binding library or other methods instead.
         var modal = $(this)
      ...
      function sendReport(sender, reciever) {
            ...
            var checkedValue = $('input:radio[name=optionsRadios]:checked').val();
...
<script type="text/javascript">
	function chatting(matchingId){
		document.location.href="chatting1.do?matchingId=" + matchingId;
	}

...
<body>
	...
	<table class="freeboard_view" style="width:1100px;">
		...
		<tbody>
			<tr>
				<th scope="row">제목</th>
				<td><input type="text" id="Title" name="inqTitle" style="width:1000px; border-radius: 2px;"class="wdp_90" value="RE: ${inqTitle }"></input></td>
			</tr>
			<tr>
				<th scope="row">작성자</th>
				<td>
				<input type="text" style="border-radius: 2px;"id="Writer" name="inqWriter" value="${inqWriter}"></input>
				</td>
			</tr>
			<tr>
				<th>내용</th>
	...
	<div class="row" style="margin:auto">
		<div class="col-12 float-right">
			<button class="btn submit-btn float-right" type="button" style="margin-top:10px; color:black;" id="write">답변하기</button>

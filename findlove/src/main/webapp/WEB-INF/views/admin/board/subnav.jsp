...
<nav class="col-md-3">
	<div class="list-group board-sub-nav" style="margin-bottom: 20px;">
		...
		<a href="boardnoticelist.do?pageNo=1" class="list-group-item">공지사항</a>
		<a href="boardfaqlist.do?pageNo=1" class="list-group-item">FAQ</a>
		<a href="boardeventlist.do?pageNo=1" class="list-group-item">이벤트</a>
	</div>
